...
export const GetDeadline = async () => {
  ...
  try {
    ...
    const response = await fetch('http://localhost:3001/api/next_deadline', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const PostPrediction = async (predJson) => {
  ...
  try {
    ...
    const response = await fetch('http://localhost:3001/api/prediction', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const PostPredHistoryRequest = async (formJson) => {
  ...
  try {
    const response = await fetch('http://localhost:3001/api/predHistory', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
